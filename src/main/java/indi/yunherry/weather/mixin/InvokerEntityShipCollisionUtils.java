...
public abstract class InvokerEntityShipCollisionUtils implements EntityShipCollisionUtilsInvoker {
    @Unique
    public List<VsiConvexPolygonc> getShipPolygonsCollidingWithEntity$weather(@Nullable Entity entity,
                                                                              Vec3 movement,
    ...
    @Shadow protected abstract List<VsiConvexPolygonc> getShipPolygonsCollidingWithEntity(Entity entity, Vec3 movement, AABB entityBoundingBox, Level world);
}
